...
import data from "layouts/support/technicalQuery/data";
...
function Queries() {
    ...
    async function getQueries() {
        try {
            const response = await fetch(`${supportApiUrl}/api/issue/merchant?category=technical&limit=${limit}&skip=${limit * page}`, {
                method: 'GET',
                headers: {
